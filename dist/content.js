...
var DigikabuContent = (() => {
  ...
  function analyzeSchedule(userSide) {
  ...
  function getCurrentPeriodBlock(userSide) {
    const now = /* @__PURE__ */ new Date();
    ...
    for (const svg of svgElements) {
      ...
      if (startSlotIndex >= 0 && startSlotIndex < TIME_SLOTS.length && endSlotIndex >= 0 && endSlotIndex < TIME_SLOTS.length) {
  ...
  function getPeriodInfo(userSide) {
    const now = /* @__PURE__ */ new Date();
    const currentTime = now.getHours() * 60 + now.getMinutes();
    const analysis = analyzeSchedule(userSide);
    const block = getCurrentPeriodBlock(userSide);
    const schoolEndTime = analysis.lastPeriod ? parseTime(analysis.lastPeriod.end) : parseTime(TIME_SLOTS[TIME_SLOTS.length - 1].end);
    const diffMsToEnd = schoolEndTime.getTime() - now.getTime();
    const minutesUntilSchoolEnd = Math.max(0, Math.floor(diffMsToEnd / 6e4));
    ...
    for (const slot of TIME_SLOTS) {
      ...
      if (currentTime >= startMinutes && currentTime < endMinutes) {
        ...
        minutesRemaining = Math.max(0, Math.floor(diffMs / 6e4));
        secondsRemaining = Math.max(0, Math.floor(diffMs % 6e4 / 1e3));
        break;
      }
    }
    for (const slot of TIME_SLOTS) {
...
`;
  function TimeWidget({ theme, userSide, shadowRoot: shadowRoot2 }) {
    const [info, setInfo] = (0, import_react.useState)(null);
    const [tick, setTick] = (0, import_react.useState)(0);
    const celebrationShownRef = (0, import_react.useRef)(false);
    ...
    (0, import_react.useEffect)(() => {
      refresh();
      const id = window.setInterval(refresh, 1e3);
      return () => clearInterval(id);
    }, [refresh]);
    (0, import_react.useEffect)(() => {
      if (!shadowRoot2) return;
      if (shadowRoot2.getElementById("__widget-styles")) return;
      const style = document.createElement("style");
      style.id = "__widget-styles";
      style.textContent = WIDGET_CSS;
      shadowRoot2.insertBefore(style, shadowRoot2.firstChild);
    }, [shadowRoot2]);
    function checkCelebration(periodInfo) {
      if (!periodInfo.schoolEndTime) return;
      const now2 = /* @__PURE__ */ new Date();
      const diff = now2.getTime() - periodInfo.schoolEndTime.getTime();
      const today = now2.toDateString();
      const lastCelebration = localStorage.getItem("__dk_celebration");
      if (diff >= 0 && diff <= 6e4 && lastCelebration !== today && !celebrationShownRef.current) {
    ...
    function showCelebration() {
      ...
      <div style="position:fixed;top:50%;left:50%;transform:translate(-50%,-50%);
        ...
        <div style="font-size:52px;margin-bottom:16px">\u{1F389}</div>
        ...
        <p style="color:rgba(255,255,255,0.65);font-family:Space Grotesk,sans-serif;font-size:15px">Enjoy your free time! \u{1F680}</p>
      </div>
    `;
      document.body.appendChild(el);
      setTimeout(() => el.remove(), 8e3);
    }
    if (!info) return null;
    const now = /* @__PURE__ */ new Date();
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: `widget widget--${theme}`, children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "widget-glow" }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "widget-inner", children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "widget-header", children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "pulse-dot" }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "widget-label", children: info.isInPeriod ? info.periodType : info.nextPeriod && info.minutesUntilNext < 60 ? "Pause" : "Aktuelle Zeit" }),
          info.isInPeriod && info.period && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "widget-mode-tag", children: info.period.name })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "widget-time", children: info.isInPeriod ? formatCountdown(info.minutesRemaining, info.secondsRemaining) : info.nextPeriod && info.minutesUntilNext < 60 ? `${info.minutesUntilNext} Min Pause` : timeStr }, tick),
        info.isInPeriod && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "widget-progress-wrap", children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "widget-progress-bar", style: { width: `${progressPct}%` } }) }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "widget-footer", children: [
          info.isInPeriod && info.periodEndTime && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "widget-footer-item", children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("svg", { className: "widget-footer-icon", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("circle", { cx: "12", cy: "12", r: "10" }),
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("polyline", { points: "12 6 12 12 16 14" })
            ] }),
            "Ende ",
            info.periodEndTime.toLocaleTimeString("de-DE", { hour: "2-digit", minute: "2-digit" }),
            " Uhr"
          ] }),
          !info.isInPeriod && info.nextPeriod && info.minutesUntilNext < 60 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "widget-footer-item", children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("svg", { className: "widget-footer-icon", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("polyline", { points: "5 12 12 5 19 12" }) }),
            info.nextPeriod.name,
            " ab ",
            info.nextPeriod.start,
            " Uhr"
          ] }),
          schoolEndStr && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "widget-footer-item", style: { marginLeft: "auto" }, children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("svg", { className: "widget-footer-icon", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", children: [
            ...
            schoolEndStr,
            " (",
            formatDuration(info.minutesUntilSchoolEnd),
            ")"
          ] })
        ] })
      ] })
  ...
  // src/content/components/SideDialog.tsx
...
`;
  function SideDialog({ theme, onSelect }) {
    const [injectedStyles, setInjectedStyles] = (0, import_react2.useState)(false);
    return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(import_jsx_runtime2.Fragment, { children: [
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("style", { children: DIALOG_CSS }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: `dialog dialog--${theme}`, children: [
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "dialog-icon", children: "\u{1F4CB}" }),
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "dialog-title", children: "Geteilter Stundenplan erkannt" }),
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "dialog-desc", children: "Deine Klasse hat einen geteilten Stundenplan. Welche Seite betrifft dich? Diese Einstellung wird gespeichert." }),
        /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "dialog-buttons", children: [
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("button", { className: "dialog-btn", onClick: () => onSelect("left"), children: "\u2190 Links" }),
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("button", { className: "dialog-btn", onClick: () => onSelect("right"), children: "Rechts \u2192" })
        ] })
      ] })
    ] });
  }
  ...
  var settings = null;
  var timeWidgetRoot = null;
  var timeWidgetContainer = null;
  var shadowRoot = null;
  ...
  function mountTimeWidget(s) {
    ...
    timeWidgetRoot = (0, import_client.createRoot)(mountPoint);
    ...
    if (isSplit && !s.sidePreference) {
      timeWidgetRoot.render(
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
          SideDialog,
          {
            theme: s.theme,
            onSelect: async (side) => {
              const { saveSettings: saveSettings2 } = await Promise.resolve().then(() => (init_storage(), storage_exports));
              await saveSettings2({ sidePreference: side });
              if (shadowRoot && mountPoint) {
                (0, import_client.createRoot)(mountPoint).render(
                  /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(TimeWidget, { theme: s.theme, userSide: side, shadowRoot })
                );
              }
            }
          }
      ...
      timeWidgetRoot.render(
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(TimeWidget, { theme: s.theme, userSide: s.sidePreference, shadowRoot })
      );
    }
  }
  function hasSplitSchedule() {
    return !!document.querySelector('svg[width="50%"]');
  }
  function removeTimeWidget() {
    if (timeWidgetRoot) {
      try {
        timeWidgetRoot.unmount();
      } catch {
      }
      timeWidgetRoot = null;
    }
