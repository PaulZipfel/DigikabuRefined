// src/content/components/FloatingLines.tsx
// WebGL shader-based floating wave lines — original component adapted for extension
// CSS inlined (no separate import needed)
...
const FloatingLines: React.FC<FloatingLinesProps> = ({
  ...
  const getCount = (waveType: 'top' | 'middle' | 'bottom'): number => {
  ...
  const getDist = (waveType: 'top' | 'middle' | 'bottom'): number => {
  ...
  return (
    <>
      <style>{FLOATING_LINES_CSS}</style>
      <div
        ref={containerRef}
